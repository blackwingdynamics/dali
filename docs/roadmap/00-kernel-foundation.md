...
- [x] Move exception-save word capture into the architecture port.
...
- [x] Service the watchdog at bounded repository-stream progress points during
...
- [x] Add a dedicated installer bulk interface; keep the existing CDC strictly
