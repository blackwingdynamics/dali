...
- `kernel/src/runtime/scheduling/saved_state.rs` — the scheduler now stores an
  opaque architecture context record; exception-word capture remains in the
  architecture-specific scheduling adapter;
