...
#[cfg(feature = "abi-mpu")]
pub const ISOLATION_LAYOUT: Option<crate::mpu::IsolationLayout> =
    crate::mpu::IsolationLayout::from_memory(TARGET_F405.memory);
#[cfg(feature = "abi-mpu")]
...
pub fn activate_application_regions(slot: dali_targets::IsolationSlot) -> bool {
    let Some(layout) = crate::mpu::IsolationLayout::from_memory_for_slot(TARGET_F405.memory, slot)
    else {
        return false;
    };
