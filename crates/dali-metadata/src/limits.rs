...
/// Maximum cartridge records in one targets document.
...
/// Maximum cartridge scopes in one developer delegation.
...
/// Maximum bytes in a cartridge version string.
pub const MAX_CARTRIDGE_VERSION_BYTES: usize = 32;
