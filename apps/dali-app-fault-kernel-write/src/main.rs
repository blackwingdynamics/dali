...
const TEST_MESSAGE: &str = "Fault injection: kernel memory write";
...
/// Enters the kernel-memory write fault test after proving SVC communication.
///
/// # Safety
///
...
pub unsafe extern "C" fn amiran_entry() -> ! {
    ...
    unsafe {
        ...
        core::ptr::write_volatile(KERNEL_PROBE_ADDRESS as *mut u32, 0);
    }
    loop {
        core::hint::spin_loop();
    }
