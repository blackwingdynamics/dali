...
const TEST_MESSAGE: &str = "Fault injection: slot0 read of slot1 memory";
const TARGET_SLOT_ID: u8 = 1;
...
/// Enters the reverse slot-boundary fault test after proving SVC communication.
///
/// # Safety
///
